          ...
          input: [
            {
              ...
              content: [
                ...
                "Use preparationTasks only for tasks done before the cooking session starts, usually at least 1 hour earlier or overnight, such as soaking legumes, thawing frozen food, marinating, or preparing dough ahead.",
                "Keep short waits, cooling, resting, simmering, or chilling steps that happen between normal cooking steps in instructions, not preparationTasks.",
