...
import 'package:cookbuk/ui/pages/statistics_page.dart';
...
final router = GoRouter(
  ...
  routes: [
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(
          path: '/settings',
          builder: (context, state) =>
              StatusPage(mealPlanRepo: mealPlanRepo, recipeRepo: repo),
        ),
    ...
    GoRoute(
      path: '/statistics',
      builder: (context, state) => StatisticsPage(repo: repo),
    ),
  ],
);
